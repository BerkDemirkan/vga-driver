...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {o_segments[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {o_segments[0]}]
set_property PACKAGE_PIN W6 [get_ports {o_segments[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {o_segments[1]}]
set_property PACKAGE_PIN U8 [get_ports {o_segments[2]}]
...
set_property PACKAGE_PIN U5 [get_ports {o_segments[4]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {o_segments[4]}]
set_property PACKAGE_PIN V5 [get_ports {o_segments[5]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {o_segments[5]}]
set_property PACKAGE_PIN U7 [get_ports {o_segments[6]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {o_segments[6]}]

set_property PACKAGE_PIN V7 [get_ports {o_segments[7]}]
